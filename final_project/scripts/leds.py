...
if len(sys.argv) < 4 or len(sys.argv) > 5:
  ...
  print "\tFlag: First payload byte to send.  Should be 0x00, 0x01, 0x02, or 0x03.  Other values will result in the error pattern being shown"
  print "\tPayload: This is optional.  Used with flag 0x03 as the second payload byte."
  print "\n"
  sys.exit(1)
